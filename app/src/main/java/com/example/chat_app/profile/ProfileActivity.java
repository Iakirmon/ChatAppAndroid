package com.example.chat_app.profile;
...
import com.example.chat_app.password.ChangePasswordActivity;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void changeImage(View view){
        if(serverFileUri==null){
            ...
            popupMenu.getMenuInflater().inflate(R.menu.menu_pi, popupMenu.getMenu());
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==102){
            if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(ProfileActivity.this, R.string.permission_required,Toast.LENGTH_SHORT).show();
            }
        }
    }
